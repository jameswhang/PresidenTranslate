...
class TranslationService(object):
    def __init__(self, president): 
        ...
        self.begin_words = {
            ...
            'Excuse me,' : (0.40, None),
            'You know the funny thing,' : (0.35, None),
            'Just so you understand -- ' : (0.2, None),
            ...
            'Wrong. Wrong.': (0.3, 'No, you\'re still wrong.'),
            'That\'s called business, by the way.' : (0.2, 'Ha!'),
            ...
            'You\'re fired!' (0.25, 'Oh really? Did I say that?'),
